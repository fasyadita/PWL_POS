...
<tr>
    <td width="15%" class="text-center">
        <img src="data:image/png;base64,{{ base64_encode(file_get_contents(public_path('adminlte/dist/img/poltek.png'))) }}" class="image">
    </td>
    <td width="85%">
...
<h3 class="text-center">LAPORAN DATA KETEGORI</h3>
